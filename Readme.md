...
# Configuration Script – mVap con descripciones en Esp e In - Rev. A

This **Configuration** script is designed for the **mVap con descripciones en Esp e In** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – mVap con descripciones en Esp e In Rev. A

Este script de **Configuration** está diseñado para el modelo **mVap con descripciones en Esp e In** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
